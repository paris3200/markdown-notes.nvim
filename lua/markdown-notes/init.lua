...
function M.setup_keymaps()
	...
	-- Daily notes
	map("n", "daily_note_today", function()
		daily.open_daily_note(0)
	end, "Open today's note")
	map("n", "daily_note_yesterday", function()
		daily.open_daily_note(-1)
	end, "Open yesterday's note")
	map("n", "daily_note_tomorrow", function()
		daily.open_daily_note(1)
	...
	vim.api.nvim_create_user_command(
		"MarkdownNotesWorkspaceShowDefault",
		workspace.show_default_workspace,
		{ desc = "Show default workspace" }
	)
